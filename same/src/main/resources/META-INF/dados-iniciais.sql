...
INSERT INTO questao_prova (id, enunciado, prova_id, versao, status) VALUES (1, 'Quanto é 1 + 1?', 1, 0, 'ATIVO');
INSERT INTO alternativa_prova (id, descricao, resposta, questao_prova_id, versao, status) VALUES (1, '1', 0, 1, 0, 'ATIVO');
INSERT INTO alternativa_prova (id, descricao, resposta, questao_prova_id, versao, status) VALUES (2, '2', 1, 1, 0, 'ATIVO');
INSERT INTO alternativa_prova (id, descricao, resposta, questao_prova_id, versao, status) VALUES (3, '3', 0, 1, 0, 'ATIVO');

-- -- QUESTÃO-PROVA
INSERT INTO questao_prova (id, enunciado, prova_id, versao, status) VALUES (2, 'Quanto é 2 + 2?', 1, 0, 'ATIVO');
INSERT INTO alternativa_prova (id, descricao, resposta, questao_prova_id, versao, status) VALUES (4, '4', 1, 2, 0, 'ATIVO');
INSERT INTO alternativa_prova (id, descricao, resposta, questao_prova_id, versao, status) VALUES (5, '2', 0, 2, 0, 'ATIVO');
INSERT INTO alternativa_prova (id, descricao, resposta, questao_prova_id, versao, status) VALUES (6, '3', 0, 2, 0, 'ATIVO');

-- -- ALTERNATIVA-QUESTÃO
INSERT INTO questao_prova (id, enunciado, prova_id, versao, status) VALUES (3, 'Quanto é 3 + 3?', 1, 0, 'ATIVO');
INSERT INTO alternativa_prova (id, descricao, resposta, questao_prova_id, versao, status) VALUES (7, '1', 0, 3, 0, 'ATIVO');
INSERT INTO alternativa_prova (id, descricao, resposta, questao_prova_id, versao, status) VALUES (8, '2', 0, 3, 0, 'ATIVO');
